...
public class Aluno {
    ...
    public void validaCpf() {
        ...
        int c1 = Integer.parseInt(sep[0]);
        int c2 = Integer.parseInt(sep[1]);
        int c3 = Integer.parseInt(sep[2]);
        int d1 = Integer.parseInt(sep[3]);
        

        System.out.println("c1: " + c1 + " c2: " + c2 + " c3: " + c3 + " d1: "+d1);
    }
    // #endregion
